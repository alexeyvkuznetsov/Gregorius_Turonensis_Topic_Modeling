...
# https://github.com/trinker/topicmodels_learning/blob/master/scripts/Example_topic_model_analysis.R
# https://github.com/trinker/topicmodels_learning/blob/master/functions/topicmodels2LDAvis.R
...
###this function prepares the that for the package ldaviz
#https://github.com/trinker/topicmodels_learning/blob/master/functions/topicmodels2LDAvis.R
